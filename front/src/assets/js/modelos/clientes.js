            ...
            try {
                ...
                datos.value = response.data;
                        ...
                        clientes.forEach(item=>{
                            console.log(item.activo +' '+ item.telefono +' '+'\n');
                        });
...
//     methods: {
//   actualizarItems(productos,proveedores,clientes) {
//     this.$store.dispatch('actualizaritems1',productos);
//     this.$store.dispatch('actualizaritems2',proveedores);
//     this.$store.dispatch('actualizaritems3',clientes);
//                  }
//             },
